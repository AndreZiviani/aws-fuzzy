...
var AwsServices = map[string]AwsService{
	...
	"acmpca": AwsService{Name: "ACMPCA", Types: []string{"CertificateAuthority","CertificateAuthorityActivation"}},
	...
	"appconfig": AwsService{Name: "AppConfig", Types: []string{"Application","ConfigurationProfile","DeploymentStrategy","Environment","ExtensionAssociation","HostedConfigurationVersion"}},
	...
	"appmesh": AwsService{Name: "AppMesh", Types: []string{"GatewayRoute","Mesh","Route","VirtualGateway","VirtualNode","VirtualRouter","VirtualService"}},
	"apprunner": AwsService{Name: "AppRunner", Types: []string{"Service","VpcConnector"}},
	"appstream": AwsService{Name: "AppStream", Types: []string{"Application","DirectoryConfig","Fleet","Stack"}},
	...
	"bedrock": AwsService{Name: "Bedrock", Types: []string{"Guardrail","KnowledgeBase"}},
	...
	"cognito": AwsService{Name: "Cognito", Types: []string{"IdentityPool","UserPoolClient","UserPoolGroup"}},
	"config": AwsService{Name: "Config", Types: []string{"ConfigurationRecorder","ConformancePackCompliance","ResourceCompliance"}},
	"connect": AwsService{Name: "Connect", Types: []string{"Instance","PhoneNumber","QuickConnect"}},
	"customerprofiles": AwsService{Name: "CustomerProfiles", Types: []string{"Domain","ObjectType"}},
	"dms": AwsService{Name: "DMS", Types: []string{"Certificate","Endpoint","EventSubscription","ReplicationInstance","ReplicationSubnetGroup","ReplicationTask"}},
	...
	"ec2": AwsService{Name: "EC2", Types: []string{"CapacityReservation","CarrierGateway","ClientVpnEndpoint","CustomerGateway","DHCPOptions","EC2Fleet","EIP","EgressOnlyInternetGateway","FlowLog","Host","IPAM","IPAMPool","IPAMScope","Instance","InternetGateway","LaunchTemplate","NatGateway","NetworkAcl","NetworkInsightsAccessScope","NetworkInsightsAccessScopeAnalysis","NetworkInsightsPath","NetworkInterface","PrefixList","RegisteredHAInstance","RouteTable","SecurityGroup","SpotFleet","Subnet","SubnetRouteTableAssociation","TrafficMirrorFilter","TrafficMirrorSession","TrafficMirrorTarget","TransitGateway","TransitGatewayAttachment","TransitGatewayConnect","TransitGatewayMulticastDomain","TransitGatewayRouteTable","VPC","VPCBlockPublicAccessExclusion","VPCBlockPublicAccessOptions","VPCEndpoint","VPCEndpointService","VPCPeeringConnection","VPNConnection","VPNGateway","Volume"}},
	"ecr": AwsService{Name: "ECR", Types: []string{"PublicRepository","PullThroughCacheRule","RegistryPolicy","Repository"}},
	"ecs": AwsService{Name: "ECS", Types: []string{"CapacityProvider","Cluster","Service","TaskDefinition","TaskSet"}},
	...
	"elasticloadbalancingv2": AwsService{Name: "ElasticLoadBalancingV2", Types: []string{"Listener","LoadBalancer"}},
	...
	"evidently": AwsService{Name: "Evidently", Types: []string{"Launch","Project","Segment"}},
	...
	"groundstation": AwsService{Name: "GroundStation", Types: []string{"Config","DataflowEndpointGroup","MissionProfile"}},
	"guardduty": AwsService{Name: "GuardDuty", Types: []string{"Detector","Filter"}},
	"iam": AwsService{Name: "IAM", Types: []string{"Group","OIDCProvider","Policy","Role","SAMLProvider","ServerCertificate","User"}},
	"ivs": AwsService{Name: "IVS", Types: []string{"Channel","PlaybackKeyPair","RecordingConfiguration"}},
	"imagebuilder": AwsService{Name: "ImageBuilder", Types: []string{"ContainerRecipe","DistributionConfiguration","ImagePipeline","ImageRecipe","InfrastructureConfiguration"}},
	"inspectorv2": AwsService{Name: "InspectorV2", Types: []string{"Activation","Filter"}},
	"iot": AwsService{Name: "IoT", Types: []string{"AccountAuditConfiguration","Authorizer","CACertificate","CustomMetric","Dimension","FleetMetric","JobTemplate","MitigationAction","Policy","ProvisioningTemplate","RoleAlias","ScheduledAudit","SecurityProfile"}},
	...
	"iotsitewise": AwsService{Name: "IoTSiteWise", Types: []string{"AssetModel","Dashboard","Gateway","Portal","Project"}},
	"iottwinmaker": AwsService{Name: "IoTTwinMaker", Types: []string{"Entity","Scene","SyncJob","Workspace"}},
	...
	"lambda": AwsService{Name: "Lambda", Types: []string{"CodeSigningConfig","Function"}},
	...
	"m2": AwsService{Name: "M2", Types: []string{"Environment"}},
	"msk": AwsService{Name: "MSK", Types: []string{"BatchScramSecret","Cluster","ClusterPolicy","Configuration","VpcConnection"}},
	"mediaconnect": AwsService{Name: "MediaConnect", Types: []string{"FlowSource","FlowVpcInterface","Gateway"}},
	"mediapackage": AwsService{Name: "MediaPackage", Types: []string{"PackagingConfiguration","PackagingGroup"}},
	"mediatailor": AwsService{Name: "MediaTailor", Types: []string{"PlaybackConfiguration"}},
	"memorydb": AwsService{Name: "MemoryDB", Types: []string{"SubnetGroup"}},
	...
	"opensearchserverless": AwsService{Name: "OpenSearchServerless", Types: []string{"VpcEndpoint"}},
	"panorama": AwsService{Name: "Panorama", Types: []string{"Package"}},
	...
	"quicksight": AwsService{Name: "QuickSight", Types: []string{"DataSource"}},
	"rds": AwsService{Name: "RDS", Types: []string{"DBCluster","DBClusterSnapshot","DBInstance","DBSecurityGroup","DBSnapshot","DBSubnetGroup","EventSubscription","GlobalCluster","OptionGroup"}},
	"rum": AwsService{Name: "RUM", Types: []string{"AppMonitor"}},
	"redshift": AwsService{Name: "Redshift", Types: []string{"Cluster","ClusterParameterGroup","ClusterSecurityGroup","ClusterSnapshot","ClusterSubnetGroup","EndpointAccess","EndpointAuthorization","EventSubscription","ScheduledAction"}},
	"resiliencehub": AwsService{Name: "ResilienceHub", Types: []string{"App","ResiliencyPolicy"}},
	"resourceexplorer2": AwsService{Name: "ResourceExplorer2", Types: []string{"Index"}},
	...
	"route53resolver": AwsService{Name: "Route53Resolver", Types: []string{"FirewallDomainList","FirewallRuleGroup","FirewallRuleGroupAssociation","ResolverEndpoint","ResolverQueryLoggingConfig","ResolverQueryLoggingConfigAssociation","ResolverRule","ResolverRuleAssociation"}},
	"s3": AwsService{Name: "S3", Types: []string{"AccessPoint","AccountPublicAccessBlock","Bucket","MultiRegionAccessPoint","StorageLens"}},
	"s3express": AwsService{Name: "S3Express", Types: []string{"BucketPolicy","DirectoryBucket"}},
	"s3tables": AwsService{Name: "S3Tables", Types: []string{"TableBucket"}},
	...
	"ssm": AwsService{Name: "SSM", Types: []string{"AssociationCompliance","Document","FileData","ManagedInstanceInventory","PatchCompliance"}},
	...
	"transfer": AwsService{Name: "Transfer", Types: []string{"Agreement","Certificate","Connector","Profile","Workflow"}},
