...
var AwsServices = map[string]AwsService{
	...
	"route53resolver": AwsService{Name: "Route53Resolver", Types: []string{"FirewallDomainList","FirewallRuleGroup","FirewallRuleGroupAssociation","ResolverQueryLoggingConfig","ResolverQueryLoggingConfigAssociation","ResolverRule","ResolverRuleAssociation"}},
